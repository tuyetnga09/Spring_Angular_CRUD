...
export class CustomerComponent {
  ...
  register()
  {
    ...
    this.http.post("http://localhost:8084/api/v1/customer/create",bodyData,{responseType: 'text'}).subscribe((resultData: any)=>
    {
        console.log(resultData);
  ...
  UpdateRecords()
  {
    ...
    this.http.put("http://localhost:8084/api/v1/customer/updateCustomer",bodyData,{responseType: 'text'}).subscribe((resultData: any)=>
    {
        console.log(resultData);
